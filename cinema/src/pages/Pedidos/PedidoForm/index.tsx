											...
											<div className="row">
												...
												<div className="col-md-6 mb-3">
													...
													{errors.valorUnitario && (
														<div
															className="text-danger small mt-1">{errors.valorUnitario}</div>
													)}
												</div>
											</div>
											<div className="mb-3">
												...
												<div className="card-body">
													...
													<p className="card-text">
														...
														<small className="text-muted ms-2">
															x{lanche.qtUnidade} =
															R$ {(lanche.subtotal || lanche.valorUnitario * lanche.qtUnidade).toFixed(2)}
														</small>
													</p>
													<p className="card-text">
														<small
															className="text-muted">Disponíveis: {lanche.qtDisponivel}</small>
													</p>
												</div>
