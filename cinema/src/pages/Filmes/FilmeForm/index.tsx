...
export const FilmeForm = () => {
    ...
    useEffect(() => {
        const loadFilme = async () => {
            if (!id) return;
            try {
                const filme = await filmeService.getById(id as any);
                setFormData({
                    titulo: filme.titulo || '',
                    ...
                    elenco: filme.elenco || '',
                    genero: (filme.genero as GeneroType) || Genero.ACAO,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (id) {
                await filmeService.update(id as any, {
                    ...validatedData,
            ...
            if (error.issues) {
                ...
                const errorMessage = error.response.data?.message || error.response.statusText || (id ? 'Erro ao atualizar filme' : 'Erro ao cadastrar filme');
                ...
                alert(`Erro: ${error.message || (id ? 'Erro desconhecido ao atualizar filme' : 'Erro desconhecido ao cadastrar filme')}`);
			...
			<div className="row justify-content-center">
				<div className="col-md-8">
                    <h1 className="mb-4">
                        ...
                        {id ? 'Editar Filme' : 'Cadastrar Filme'}
                    </h1>
					...
					<form onSubmit={handleSubmit}>
                        ...
                        <div className="d-flex gap-2">
                            <Button type="submit" label={id ? 'Atualizar' : 'Cadastrar'} variant="primary"/>
                            <Button
                                type="button"
                                label="Cancelar"
                                variant="secondary"
